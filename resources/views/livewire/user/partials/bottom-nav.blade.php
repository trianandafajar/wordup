...
<nav
    ...
    <a href="{{ route('user.learn') }}"
        class="flex-1 flex flex-col items-center gap-0.5 py-1 transition-colors {{ $active === 'learn' ? 'text-brand-500' : 'text-gray-400' }}">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
            <path
    ...
    <a href="{{ route('user.leaderboard') }}"
        class="flex-1 flex flex-col items-center gap-0.5 py-1 transition-colors {{ $active === 'rank' ? 'text-brand-500' : 'text-gray-400' }}">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
    ...
    <a href="{{ route('user.profile') }}"
        class="flex-1 flex flex-col items-center gap-0.5 py-1 transition-colors {{ $active === 'profile' ? 'text-brand-500' : 'text-gray-400' }}">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
            <path fill-rule="evenodd"
