            ...
            <div class="lg:rounded-none lg:border-0 lg:bg-transparent lg:p-0 lg:shadow-none">
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-4">
                    ...
                    <div x-data="{ showPassword: false }">
                        <div>
                            <label for="password" class="mb-2 block text-sm font-semibold text-gray-dark">Kata sandi
                                baru</label>
                            <div class="relative">
                        ...
                        <div>
                            <label for="password_confirmation"
                                class="mb-2 block text-sm font-semibold text-gray-dark">Konfirmasi kata sandi</label>
                            <div class="relative">
