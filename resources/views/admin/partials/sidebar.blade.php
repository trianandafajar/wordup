<aside x-data="{ sidebarHover: false, isDesktop: window.innerWidth >= 1280 }" :class="[
        sidebarToggle ? (isDesktop ? 'sidebar-hover-collapsed translate-x-0 lg:w-[90px]' : 'translate-x-0 lg:w-[290px]') : '-translate-x-full lg:w-[290px]',
        sidebarHover ? 'sidebar-hover' : '',
    ]" @mouseenter="if (sidebarToggle && isDesktop) sidebarHover = true" @mouseleave="sidebarHover = false"
    @resize.window="isDesktop = window.innerWidth >= 1280"
    class="sidebar fixed left-0 top-0 z-999999 flex h-screen w-[290px] flex-col overflow-y-hidden border-r border-gray-200 bg-white px-5 duration-300 ease-linear dark:border-gray-800 dark:bg-gray-900 lg:translate-x-0"
    ...
    <div :class="sidebarToggle && isDesktop ? 'justify-center' : 'justify-between'"
        ...
        <a href="{{ filament()->getUrl() }}" class="flex items-center gap-2">
            ...
            <span class="menu-item-text text-xl font-bold text-brand-600 dark:text-brand-400"
                :class="sidebarToggle && isDesktop ? 'hidden' : 'inline'">WordUp</span>
        </a>
    </div>
                    ...
                    <li>
                        <a href="{{ filament()->getUrl() }}"
                            ...
                            <span class="menu-item-text"
                                :class="sidebarToggle && isDesktop ? 'lg:hidden' : ''">Dashboard</span>
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <ul class="flex flex-col gap-1.5">
                    <li>
                        <a href="{{ \App\Filament\Resources\CourseResource::getUrl('index') }}"
                            ...
                            <span class="menu-item-text"
                                :class="sidebarToggle && isDesktop ? 'lg:hidden' : ''">Courses</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ \App\Filament\Resources\UnitResource::getUrl('index') }}"
                            ...
                            <span class="menu-item-text"
                                :class="sidebarToggle && isDesktop ? 'lg:hidden' : ''">Units</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ \App\Filament\Resources\LessonResource::getUrl('index') }}"
                            ...
                            <span class="menu-item-text"
                                :class="sidebarToggle && isDesktop ? 'lg:hidden' : ''">Lessons</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ \App\Filament\Resources\QuestionResource::getUrl('index') }}"
                            ...
                            <span class="menu-item-text"
                                :class="sidebarToggle && isDesktop ? 'lg:hidden' : ''">Questions</span>
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <ul class="flex flex-col gap-1.5">
                    <li>
                        <a href="{{ \App\Filament\Resources\UserResource::getUrl('index') }}"
                            ...
                            <span class="menu-item-text"
                                :class="sidebarToggle && isDesktop ? 'lg:hidden' : ''">Users</span>
                        </a>
                    </li>
                </ul>
            </div>
