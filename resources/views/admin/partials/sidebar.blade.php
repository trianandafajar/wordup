                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    <li>
                        <a href="{{ filament()->getUrl() }}"
                            ...
                            <span class="menu-item-text" :class="sidebarToggle && isDesktop ? 'lg:hidden' : ''">Dashboard</span>
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    <li>
                        <a href="{{ \App\Filament\Resources\CourseResource::getUrl('index') }}"
                            ...
                            <span class="menu-item-text" :class="sidebarToggle && isDesktop ? 'lg:hidden' : ''">Courses</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ \App\Filament\Resources\UnitResource::getUrl('index') }}"
                            ...
                            <span class="menu-item-text" :class="sidebarToggle && isDesktop ? 'lg:hidden' : ''">Units</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ \App\Filament\Resources\LessonResource::getUrl('index') }}"
                            ...
                            <span class="menu-item-text" :class="sidebarToggle && isDesktop ? 'lg:hidden' : ''">Lessons</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ \App\Filament\Resources\QuestionResource::getUrl('index') }}"
                            ...
                            <span class="menu-item-text" :class="sidebarToggle && isDesktop ? 'lg:hidden' : ''">Questions</span>
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    <li>
                        <a href="{{ \App\Filament\Resources\UserResource::getUrl('index') }}"
                            ...
                            <span class="menu-item-text" :class="sidebarToggle && isDesktop ? 'lg:hidden' : ''">Users</span>
                        </a>
                    </li>
                </ul>
            </div>
