            ...
            [
                ...
                'lessons' => [
                    ...
                    [
                        ...
                        'type' => 'reading',
                        'xp' => 20,
                        'explanation' => '<h3>Talking About Yourself</h3><p>When meeting someone new:</p><ul><li><strong>My name is...</strong> / <strong>I\'m...</strong></li><li><strong>I\'m from...</strong> (country/city)</li><li><strong>I live in...</strong></li><li><strong>I\'m a student / worker</strong></li></ul>',
                        'questions' => [
            ...
            [
                ...
                'lessons' => [
                    ...
                    [
                        ...
                        'type' => 'reading',
                        'xp' => 20,
                        'explanation' => '<h3>Work and School</h3><ul><li><strong>go to work/school</strong></li><li><strong>have a meeting</strong></li><li><strong>finish work</strong></li><li><strong>come home</strong></li></ul>',
                        'questions' => [
                    ...
                    [
                        ...
                        'type' => 'reading',
                        'xp' => 20,
                        'explanation' => '<h3>Evening Activities</h3><ul><li><strong>have dinner</strong></li><li><strong>watch TV</strong></li><li><strong>go to bed</strong></li><li><strong>fall asleep</strong></li></ul>',
                        'questions' => [
            ...
            [
                ...
                'lessons' => [
                    [
                        ...
                        'type' => 'reading',
                        'xp' => 20,
                        'explanation' => '<h3>Food Vocabulary</h3><ul><li><strong>Fruits:</strong> apple, banana, orange</li><li><strong>Vegetables:</strong> tomato, potato, carrot</li><li><strong>Grains:</strong> rice, bread, pasta</li></ul>',
                        'questions' => [
                    ...
                    [
                        ...
                        'type' => 'reading',
                        'xp' => 20,
                        'explanation' => '<h3>At a Restaurant</h3><ul><li><strong>I would like...</strong></li><li><strong>Can I have...?</strong></li><li><strong>Could I get the bill, please?</strong></li></ul>',
                        'questions' => [
                    ...
                    [
                        ...
                        'type' => 'reading',
                        'xp' => 20,
                        'explanation' => '<h3>Prices</h3><ul><li><strong>How much is this?</strong></li><li><strong>It costs...</strong></li><li><strong>Can I pay by card?</strong></li></ul>',
                        'questions' => [
            ...
            [
                ...
                'lessons' => [
                    ...
                    [
                        ...
                        'type' => 'reading',
                        'xp' => 30,
                        'explanation' => '<h3>Directions</h3><ul><li><strong>Turn left / right</strong></li><li><strong>Go straight</strong></li><li><strong>Across from / next to</strong></li></ul>',
                        'questions' => [
            ...
            [
                ...
                'lessons' => [
                    [
                        ...
                        'type' => 'reading',
                        'xp' => 30,
                        'explanation' => '<h3>Past Tense</h3><p>Regular verbs add -ed. Irregular verbs change form (go -> went, eat -> ate).</p>',
                        'questions' => [
                    ...
                    [
                        ...
                        'type' => 'reading',
                        'xp' => 30,
                        'explanation' => '<h3>Future Plans</h3><p>Use "am/is/are + going to + verb" for planned future actions.</p>',
                        'questions' => [
                    ...
                    [
                        ...
                        'type' => 'reading',
                        'xp' => 30,
                        'explanation' => '<h3>Will vs Going to</h3><p>Use "will" for quick decisions and predictions.</p>',
                        'questions' => [
            ...
            [
                ...
                'lessons' => [
                    [
                        ...
                        'type' => 'reading',
                        'xp' => 40,
                        'explanation' => '<h3>Professional Email</h3><p>Subject line, clear greeting, purpose in first paragraph, professional sign-off.</p>',
                        'questions' => [
                    ...
                    [
                        ...
                        'type' => 'reading',
                        'xp' => 40,
                        'explanation' => '<h3>Tone in Emails</h3><p>Use formal language for new clients and managers. Use "I wanted to follow up" instead of "Just checking in".</p>',
                        'questions' => [
            ...
            [
                ...
                'lessons' => [
                    [
                        ...
                        'type' => 'reading',
                        'xp' => 40,
                        'explanation' => '<h3>First Conditional</h3><p>If + present simple, will + base verb (real future possibility).</p>',
                        'questions' => [
                    ...
                    [
                        ...
                        'type' => 'reading',
                        'xp' => 40,
                        'explanation' => '<h3>Second Conditional</h3><p>If + past simple, would + base verb (unreal/imaginary present).</p>',
                        'questions' => [
            ...
            [
                ...
                'lessons' => [
                    [
                        ...
                        'type' => 'reading',
                        'xp' => 50,
                        'explanation' => '<h3>Academic Writing</h3><p>Introduction with thesis statement, body paragraphs with evidence, conclusion summarizing findings.</p>',
                        'questions' => [
                    ...
                    [
                        ...
                        'type' => 'reading',
                        'xp' => 50,
                        'explanation' => '<h3>Legal English</h3><p>Key terms: "hereby", "shall" (obligation), "breach of contract", "terms and conditions".</p>',
                        'questions' => [
